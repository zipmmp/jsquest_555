const { messageCommand } = require('../lib/quest/handler/messageCommand.js');
//const { ws } = require('../events/express/ws.js');
module.exports = class test extends messageCommand {
    constructor() {
        super(...arguments);
        this.name = "test";
        this.description = "A test command to verify the bot's functionality.";
        this.aliases = [];
        this.usage = "{prefix}{command} [args...]";
        this.examples = ["test"];
        this.cooldown = "1s";
        this.flags = ["devOnly", "onlyGuild"];
        this.allowedRoles = [];
    }
